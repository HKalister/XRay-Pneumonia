Proyecto de Predicción de Neumonía en Entorno Local Este proyecto despliega una aplicación Flask en Entorno Local, que permite predecir si una imagen de rayos X muestra signos de neumonía.
